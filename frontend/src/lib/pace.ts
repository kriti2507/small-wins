...
import type { Field, Block, PostDoc } from "../types";
...
export function formatValue(
  field: Field,
  value: string | number | null | undefined | Block[] | PostDoc,
): string | number {
  if (value == null || value === "" || Array.isArray(value) || typeof value === "object") return "—";
